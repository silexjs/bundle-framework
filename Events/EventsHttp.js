...
var EventsHttp = function(container, dispatcher) {
...
EventsHttp.prototype = {
	...
	onHttpServerResolveController: function(next, request, response, controller) {
	...
	onHttpServerException: function(next, e, request, response) {
